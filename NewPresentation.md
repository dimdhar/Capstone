Coursera Data Science Final Project Presentation
========================================================
author: Dimple Dhar
...
If you haven't tried out the app, go [here](https://dimpledhar.shinyapps.io/coursera_data_science_capstone__final_project_submission) to try it!


App Usage
========================================================

![Instructions](./www/HowToUseSlide.jpg)
...
<div style="align:top"><img src="./www/Algorithm.jpg" alt="algorithm flow" /></div>


Further Exploration
========================================================

- The code is available on [GitHub](https://github.com/dimdhar/data-science-capstone)
